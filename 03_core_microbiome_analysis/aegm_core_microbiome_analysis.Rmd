...
In general, we did not visually detect any outlier samples driving extreme order differentation among groups of interest (i.e., phylogeny, habitat, diet). Thus, we included all samples in core microbiome analysis.
...
In this step, we characterize the core microbiome of each phylogenetic group in the data (African savanna elephants, African forest elephants). First, we identify the core microbiome of all individuals within each group (Steps 4a.1 and 4a.2). Next, we directly compare the phylogenetic groups by controlling for diet and habitat. Since All Forest individuals are non-crop-raiding and live in forest habitat, we filter out only non-crop-raiding Savanna elephants found in forest habitat (Step 4a.3).
...
##### 4a.3. Characterize the core microbiome of only <i>L. africana</i> that were collected from forest habitat; run the Rmd chunk below.
